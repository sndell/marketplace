...
export const Header = () => (
  <div className="top-0 left-0 right-0 z-50 xs:bg-primary max-md:fixed">
    <div className="grid w-full grid-cols-[1fr_auto] xs:grid-cols-[auto_1fr] gap-3 md:grid-cols-[1fr_auto_1fr] p-2 xs:p-3 mx-auto max-w-7xl items-center">
      ...
      <div className="flex gap-2 justify-self-end">
        ...
        <button className="grid p-3 border rounded-full xs:p-2 xs:bg-primary-dark place-items-center backdrop-blur-xl bg-background/70 border-secondary/10">
