        ...
        <div className="absolute top-0 right-0 left-0 grid grid-cols-[1fr_auto] gap-2 mx-2 pt-2 bg-linear-to-b md:from-white to-100%">
          <div className="flex flex-1 gap-2 items-center p-2 rounded-full backdrop-blur-md bg-primary/90">
            ...
            <div className="flex flex-col">
              <div className="h-4 bg-gray-200 rounded-sm w-24 animate-pulse"></div>
              <div className="h-3 bg-gray-200 rounded-sm w-32 animate-pulse mt-1"></div>
            </div>
          </div>
          ...
          {[...Array(4)].map((_, index) => (
            <div key={index} className={`flex ${index % 2 === 0 ? "justify-start" : "justify-end"}`}>
              <div className="flex flex-col gap-2 max-w-[70%]">
                <div className="h-2.5 bg-gray-100 rounded-sm w-16 animate-pulse self-end"></div>
